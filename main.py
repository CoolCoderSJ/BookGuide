...
#PYINSTALLER SCRIPT
#pyinstaller -n BookGuide -w --add-data="static;static" --add-data="templates;templates" --add-data="database.db;." --add-data="README.md;." --add-data="logs;logs" -i "static/images/logo.ico" --clean main.py
